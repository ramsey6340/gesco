...
class _CountryPickerDialogState extends State<CountryPickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final height = widget.style?.height ?? mediaHeight;
    const defaultHorizontalPadding = 40.0; // default : 40.0
    const defaultVerticalPadding = 24.0; // default : 24.0
    return Dialog(
      shape: RoundedRectangleBorder(
        borderRadius: const BorderRadius.all(Radius.circular(5.0)),
      ),
      insetPadding: EdgeInsets.symmetric(
          vertical: mediaHeight > (height + defaultVerticalPadding * 2)
              ? (mediaHeight - height) / 2
